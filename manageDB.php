...
mysql_query("DROP SCHEMA trackin");
//creating database
if(!mysq_select_db('trackin',$con)){
	echo("Creating Database 'trackin'!\n<br>");
    if (mysql_query("CREATE DATABASE trackin",$con)){ echo "Database created<br>";}
	else { echo "Error creating database: " . mysql_error() . "<br>";}

	mysql_select_db("trackin", $con);
  }
